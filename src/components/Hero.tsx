        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-8">
          <div className="lg:col-span-6 xl:col-span-5 flex flex-col justify-center">
            <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-gray-900 sm:mt-5 sm:text-5xl lg:mt-6">
              ...
              <span className="block text-sky-600">appointments online</span>
            </h1>
            ...
            <div className="mt-8 sm:flex sm:justify-center lg:justify-start">
              <div className="rounded-md shadow">
                <Link to="/practitioners">
                  <Button className="w-full flex items-center justify-center px-8 py-6 text-base font-medium bg-sky-600 hover:bg-sky-700">
