        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-8">
          <div className="lg:col-span-6 xl:col-span-5 flex flex-col justify-center">
            <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-gray-900 sm:mt-5 sm:text-5xl lg:mt-6">
              ...
              <span className="block text-green-600">appointments online</span>
            </h1>
            ...
            <div className="mt-8 sm:flex sm:justify-center lg:justify-start">
              <div className="rounded-md shadow">
                <Link to="/practitioners">
                  <Button className="w-full flex items-center justify-center px-8 py-6 text-base font-medium bg-green-600 hover:bg-green-700">
              ...
              <div className="mt-3 sm:mt-0 sm:ml-3">
                <Link to="/about">
                  <Button variant="outline" className="w-full flex items-center justify-center px-8 py-6 text-base font-medium">
                    Learn more
                  </Button>
                </Link>
              </div>
          ...
          <div className="mt-12 lg:mt-0 lg:col-span-6 xl:col-span-7">
            <div className="relative h-64 sm:h-72 md:h-80 lg:h-full lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
              <img
                ...
                src="/lovable-uploads/831762b6-63e5-49ad-ac35-562d64a240c9.png"
